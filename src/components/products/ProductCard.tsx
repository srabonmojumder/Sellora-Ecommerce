    ...
    >
      <div className="bg-white overflow-hidden">
        ...
        <div className="relative aspect-[3/4] overflow-hidden bg-[#f6f6f6]">
          <Link href={productUrl} className="block absolute inset-0 z-0">
            {/* Main Image */}
            <Image
          ...
          <div
            className={`absolute bottom-0 left-0 right-0 z-10 transition-all duration-300 sm:translate-y-full sm:opacity-0 sm:group-hover:translate-y-0 sm:group-hover:opacity-100 ${
        ...
        {/* Product Info */}
        <Link href={productUrl} className="block pt-3 pb-2 px-1 text-center">
          {/* Product Name */}
